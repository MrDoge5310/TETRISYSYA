...
const int GAME_SPEED = 250;      // Game update speed in milliseconds
...
void MainWndAddWidgets(HWND hWnd)
{
	...
	//hTimer = CreateWindowA("static", "Time: 0", WS_VISIBLE | WS_CHILD | ES_LEFT, 550, 600, 100, 20, hWnd, NULL, NULL, NULL);
}
